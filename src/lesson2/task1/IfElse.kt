...
fun ageDescription(age: Int): String {
    val last_ten = age % 10
    val last_hundr = age % 100
    if (last_ten == 0 || last_ten in 5..9 || last_hundr in 11..14) return "$age лет"
    if (last_ten in 2..4) return "$age года"
    return "$age год"
}
...
fun timeForHalfWay(
    ...
    return t1 + t2 + (way - v1 * t1 - v2 * t2) / v3
}
